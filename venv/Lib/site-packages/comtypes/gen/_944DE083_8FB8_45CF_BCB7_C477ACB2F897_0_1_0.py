...
__all__ = [
    'UIA_StylesStyleIdPropertyId', 'DockPosition_Left',
    'UIA_GridItemPatternId', 'UIA_GridPatternId', 'DockPosition_Top',
    'StyleId_Title', 'IUIAutomationAndCondition',
    'CoalesceEventsOptions', 'UIA_AnnotationObjectsPropertyId',
    'UIA_Text_TextSelectionChangedEventId',
    'UIA_NavigationLandmarkTypeId', 'UIA_BoundingRectanglePropertyId',
    'IUIAutomationElement6', 'UIA_EditControlTypeId',
    'UIA_SemanticZoomControlTypeId',
    'StructureChangeType_ChildrenBulkAdded', 'StyleId_Heading7',
    'RowOrColumnMajor_ColumnMajor', 'UIA_UnderlineColorAttributeId',
    'IUIAutomationDockPattern', 'UIA_AriaPropertiesPropertyId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'ProviderOptions_ProviderOwnsSetFocus',
    'UIA_IsReadOnlyAttributeId', 'AutomationElementMode', 'ZoomUnit',
    'UIA_FlowsToPropertyId', 'IUIAutomationProxyFactoryMapping',
    'UIA_IsStylesPatternAvailablePropertyId',
    'UIA_Drag_DragStartEventId', 'UIA_SystemAlertEventId',
    'IUIAutomationTextRangeArray', 'UIA_LiveRegionChangedEventId',
    'OrientationType_Horizontal', 'UIA_SynchronizedInputPatternId',
    'ZoomUnit_SmallDecrement', 'OrientationType_None',
    'UIA_CustomNavigationPatternId', 'UIA_FillTypePropertyId',
    'UIA_ScrollItemPatternId', 'NavigateDirection_Parent',
    'UIA_AfterParagraphSpacingAttributeId',
    'UIA_LocalizedLandmarkTypePropertyId', 'HeadingLevel7',
    'UIA_StyleIdAttributeId', 'UIA_LayoutInvalidatedEventId',
    'UIA_AnimationStyleAttributeId',
    'SupportedTextSelection_Multiple', 'UIA_AcceleratorKeyPropertyId',
    'DockPosition_Right', 'UIA_MarginBottomAttributeId',
    'UIA_AnnotationAuthorPropertyId', 'UIA_CheckBoxControlTypeId',
    'UIA_SummaryChangeId', 'UIA_TableRowOrColumnMajorPropertyId',
    'TreeScope_None', 'IUIAutomationFocusChangedEventHandler',
    'SupportedTextSelection_Single', 'UIA_ComboBoxControlTypeId',
    'UIA_IsPeripheralPropertyId', 'UIA_PaneControlTypeId',
    'TextUnit_Document', 'UIA_TabsAttributeId',
    'UIA_MenuModeEndEventId', 'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_NativeWindowHandlePropertyId',
    'UIA_SelectionItem_ElementSelectedEventId', 'StructureChangeType',
    'UIA_StylesPatternId', 'IUIAutomation2',
    'UIA_RangeValueMinimumPropertyId',
    'ProviderOptions_HasNativeIAccessible', 'IUIAutomationTextRange',
    'IUIAutomationSpreadsheetPattern', 'IUIAutomationNotCondition',
    'IUIAutomationLegacyIAccessiblePattern',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'UIA_TextPatternId', 'UIA_FormLandmarkTypeId',
    'UIA_SelectionItem_ElementAddedToSelectionEventId', 'Polite',
    'UIA_IsGridPatternAvailablePropertyId',
    'UIA_ItemStatusPropertyId', 'ExpandCollapseState_LeafNode',
    'UIA_ToggleToggleStatePropertyId', 'UIA_TableItemPatternId',
    'StyleId_Heading4', 'TreeScope_Subtree', 'TreeScope_Descendants',
    'UIA_MenuOpenedEventId', 'AnnotationType_MoveChange',
    'UIA_SelectionSelectionPropertyId', 'UIA_CustomLandmarkTypeId',
    'CoalesceEventsOptions_Enabled',
    'UIA_IsDragPatternAvailablePropertyId', 'SupportedTextSelection',
    'PropertyConditionFlags_IgnoreCase', 'UIA_ObjectModelPatternId',
    'UIA_SelectionItemIsSelectedPropertyId',
    'IUIAutomationStylesPattern', 'UIA_CaretPositionAttributeId',
    'UIA_HeaderControlTypeId',
    'WindowInteractionState_ReadyForUserInteraction',
    'ProviderOptions_ClientSideProvider', 'Assertive',
    'IUIAutomationTransformPattern2',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'UIA_VirtualizedItemPatternId', 'OrientationType_Vertical',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'UIA_ClassNamePropertyId', 'UIA_TogglePatternId',
    'UIA_TableControlTypeId', 'UIA_ImageControlTypeId',
    'WindowInteractionState_Closing', 'UIA_ControllerForPropertyId',
    'UIA_IsDialogPropertyId',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'TreeScope_Ancestors', 'UIA_IsTextEditPatternAvailablePropertyId',
    'UIA_BackgroundColorAttributeId', 'NotificationProcessing',
    'LiveSetting', 'UIA_RangeValueIsReadOnlyPropertyId',
    'UIA_LegacyIAccessibleHelpPropertyId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'UIA_Transform2ZoomMinimumPropertyId',
    'UIA_AsyncContentLoadedEventId', 'NotificationKind_ItemRemoved',
    'UIA_GroupControlTypeId', 'IUIAutomationValuePattern',
    'UIA_ChangesEventId', 'OrientationType', 'UIA_CulturePropertyId',
    'TextPatternRangeEndpoint', 'UIA_SizeOfSetPropertyId',
    'TreeScope_Parent', 'UIA_OptimizeForVisualContentPropertyId',
    'ScrollAmount_NoAmount', 'UIA_AutomationPropertyChangedEventId',
    'TextUnit_Word', 'NotificationKind_Other', 'UIA_NamePropertyId',
    'TextUnit_Paragraph', 'UIA_LevelPropertyId',
    'UIA_CalendarControlTypeId', 'UIA_ProcessIdPropertyId',
    'UIA_AnnotationDateTimePropertyId',
    'WindowInteractionState_Running', 'UIA_ClickablePointPropertyId',
    'AnnotationType_Highlighted',
    'ProviderOptions_NonClientAreaProvider',
    'TextEditChangeType_AutoCorrect',
    'UIA_IsKeyboardFocusablePropertyId',
    'UIA_GridColumnCountPropertyId', 'AutomationElementMode_None',
    'UIA_IsRequiredForFormPropertyId', 'UIA_BulletStyleAttributeId',
    'CUIAutomation8', 'UIA_HeadingLevelPropertyId',
    'AnnotationType_Mathematics', 'UIA_CaretBidiModeAttributeId',
    'AnnotationType_CircularReferenceError',
    'UIA_IsOffscreenPropertyId', 'StyleId_Emphasis',
    'UIA_IsDataValidForFormPropertyId', 'UIA_MainLandmarkTypeId',
    'SynchronizedInputType_LeftMouseUp', 'UIA_ScrollPatternId',
    'AnnotationType_Footer', 'HeadingLevel2',
    'UIA_WindowWindowVisualStatePropertyId',
    'UIA_LabeledByPropertyId', 'UIA_LegacyIAccessiblePatternId',
    'ScrollAmount_LargeDecrement', 'UIA_TableColumnHeadersPropertyId',
    'IUIAutomationTextPattern2', 'UIA_StructureChangedEventId',
    'UIA_RadioButtonControlTypeId',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_AnnotationPatternId', 'SupportedTextSelection_None',
    'StyleId_BulletedList', 'HeadingLevel1',
    'UIA_IsItalicAttributeId', 'UIA_AriaRolePropertyId',
    'UIA_IsSubscriptAttributeId', 'UIA_HasKeyboardFocusPropertyId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'IUIAutomationTextRange2', 'UIA_ProgressBarControlTypeId',
    'IUIAutomationTablePattern', 'UIA_CapStyleAttributeId',
    'UIA_TextFlowDirectionsAttributeId',
    'AnnotationType_ExternalChange', 'UIA_AnnotationTypesAttributeId',
    'AnnotationType_Header', 'UIA_RuntimeIdPropertyId',
    'UIA_OverlineStyleAttributeId', 'ExpandCollapseState_Expanded',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'UIA_IsPasswordPropertyId',
    'WindowInteractionState_BlockedByModalWindow', 'IUIAutomation3',
    'IUIAutomationElement8', 'NotificationProcessing_All',
    ...
    'NavigateDirection_FirstChild', 'UIA_CultureAttributeId',
    'IUIAutomation5', 'UIA_FillColorPropertyId',
    'NotificationProcessing_ImportantAll', 'DockPosition',
    'WindowVisualState_Normal', 'IUIAutomationTreeWalker',
    'UIA_RangeValuePatternId', 'UIA_StrikethroughColorAttributeId',
    'IUIAutomationElementArray', 'AnnotationType_SpellingError',
    'CUIAutomation', 'AnnotationType_TrackChanges',
    'UIA_DockPatternId', 'StyleId_Custom', 'Off',
    'UIA_GridItemRowSpanPropertyId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_TreeItemControlTypeId', 'SynchronizedInputType_RightMouseUp',
    'UIA_ScrollVerticalViewSizePropertyId',
    'IUIAutomationTextPattern', 'UIA_FlowsFromPropertyId',
    'UIA_MenuClosedEventId', 'IUIAutomationTextChildPattern',
    'IUIAutomationOrCondition', 'CoalesceEventsOptions_Disabled',
    'RowOrColumnMajor', 'UIA_InputReachedTargetEventId',
    'UIA_OutlineStylesAttributeId',
    'IUIAutomationItemContainerPattern', 'UIA_RotationPropertyId',
    'UIA_SelectionActiveEndAttributeId', 'AnnotationType_Author',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_LineSpacingAttributeId', 'ToggleState',
    'ExpandCollapseState', 'SynchronizedInputType',
    'UIA_DropTarget_DroppedEventId', 'UIA_TabControlTypeId',
    'StructureChangeType_ChildAdded', 'UIA_DocumentControlTypeId',
    'StyleId_Normal', 'UIA_Drag_DragCompleteEventId',
    'IUIAutomation6', 'NavigateDirection_LastChild',
    'NotificationKind', 'ExpandCollapseState_PartiallyExpanded',
    'UIA_LegacyIAccessibleValuePropertyId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'ConnectionRecoveryBehaviorOptions',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'ZoomUnit_LargeIncrement', 'ToggleState_Off',
    'UIA_StrikethroughStyleAttributeId', 'UIA_OutlineColorPropertyId',
    'UIA_SelectionPattern2Id',
    'UIA_Selection2LastSelectedItemPropertyId',
    'UIA_DataItemControlTypeId', 'IUIAutomationObjectModelPattern',
    'UIA_MarginTopAttributeId', 'UIA_AppBarControlTypeId',
    'PropertyConditionFlags',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'IUIAutomationSelectionPattern2', 'UIA_ToolBarControlTypeId',
    'UIA_WindowIsModalPropertyId',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'UIA_Transform2ZoomLevelPropertyId', 'UIA_AccessKeyPropertyId',
    'UIA_IsWindowPatternAvailablePropertyId', 'IUIAutomation4',
    'StyleId_Subtitle', 'SynchronizedInputType_LeftMouseDown',
    'UIA_ItemTypePropertyId', 'TreeScope_Children',
    'UIA_LiveSettingPropertyId', 'UIA_AutomationIdPropertyId',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'TextPatternRangeEndpoint_End', 'UIA_TextEditPatternId',
    'UIA_HorizontalTextAlignmentAttributeId',
    'IUIAutomationPropertyChangedEventHandler',
    'SynchronizedInputType_RightMouseDown',
    'ProviderOptions_UseClientCoordinates',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'WindowVisualState_Minimized', 'UIA_TextChildPatternId',
    'WindowInteractionState', 'UIA_MultipleViewPatternId',
    'UIA_WindowCanMaximizePropertyId', 'UIA_PositionInSetPropertyId',
    'UIA_GridItemColumnPropertyId', 'UIA_TabItemControlTypeId',
    'HeadingLevel3', 'UIA_IsValuePatternAvailablePropertyId',
    'HeadingLevel6', 'NotificationKind_ActionAborted', 'TreeScope',
    'TextEditChangeType', 'UIA_ValueValuePropertyId',
    'UIA_ActiveTextPositionChangedEventId',
    'ToggleState_Indeterminate', 'UIA_TablePatternId',
    'UIA_StylesExtendedPropertiesPropertyId', 'DockPosition_None',
    'PropertyConditionFlags_MatchSubstring',
    'UIA_ExpandCollapsePatternId',
    'UIA_LegacyIAccessibleSelectionPropertyId', 'UiaChangeInfo',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'IUIAutomationDropTargetPattern', 'WindowVisualState_Maximized',
    'UIA_DropTarget_DragLeaveEventId', 'RowOrColumnMajor_RowMajor',
    'IUIAutomationMultipleViewPattern', 'IUIAutomationWindowPattern',
    'NotificationProcessing_ImportantMostRecent', 'DockPosition_Fill',
    'UIA_OrientationPropertyId', 'UIA_InvokePatternId',
    'UIA_SliderControlTypeId', 'IUIAutomationGridPattern',
    'UIA_ToolTipOpenedEventId',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'UIA_TableItemRowHeaderItemsPropertyId', 'TextUnit',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'PropertyConditionFlags_None', 'UIA_FontWeightAttributeId',
    'UIA_DropTargetPatternId', 'UIA_IsActiveAttributeId',
    'IUIAutomationProxyFactoryEntry', 'UIA_TreeControlTypeId',
    'UIA_WindowPatternId', 'UIA_IsScrollPatternAvailablePropertyId',
    'UIA_TextEdit_TextChangedEventId',
    'UIA_RangeValueValuePropertyId', 'IUIAutomationElement',
    'IUIAutomationStructureChangedEventHandler',
    'UIA_IsTogglePatternAvailablePropertyId', 'IUIAutomationElement9',
    'StructureChangeType_ChildrenReordered',
    'AnnotationType_Sensitive',
    'ProviderOptions_RefuseNonClientSupport',
    'UIA_IndentationFirstLineAttributeId', 'IAccessible',
    'UIA_ControlTypePropertyId',
    'UIA_GridItemContainingGridPropertyId',
    'IUIAutomationSelectionPattern', 'UIA_IsContentElementPropertyId',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'IUIAutomationEventHandlerGroup', 'UIA_DragPatternId',
    'UIA_SeparatorControlTypeId',
    'AnnotationType_AdvancedProofingIssue',
    'NotificationKind_ItemAdded', 'IRawElementProviderSimple',
    'SynchronizedInputType_KeyDown', 'AnnotationType_DeletionChange',
    'UIA_GridItemRowPropertyId', 'AnnotationType_ConflictingChange',
    'AnnotationType_GrammarError', 'UIA_MenuItemControlTypeId',
    'UIA_LegacyIAccessibleNamePropertyId', 'IUIAutomationElement7',
    'IUIAutomationNotificationEventHandler',
    'UIA_Window_WindowOpenedEventId', 'ProviderOptions',
    'IUIAutomationTextEditTextChangedEventHandler',
    'IUIAutomationDragPattern', 'UIA_DragGrabbedItemsPropertyId',
    'UIA_OutlineThicknessPropertyId',
    'IUIAutomationSelectionItemPattern',
    'UIA_UnderlineStyleAttributeId',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'UIA_RangeValueLargeChangePropertyId', 'UIA_SpinnerControlTypeId',
    'UIA_ToolTipClosedEventId', 'UIA_AnnotationTargetPropertyId',
    'ProviderOptions_UseComThreading', 'UIA_Text_TextChangedEventId',
    'IUIAutomationProxyFactory',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'UIA_IsHiddenAttributeId', 'IUIAutomationGridItemPattern',
    'UIA_StylesFillPatternStylePropertyId',
    'UIA_FullDescriptionPropertyId',
    'TextEditChangeType_AutoComplete',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_SpreadsheetPatternId', 'UIA_ToolTipControlTypeId',
    'IUIAutomationTextRange3', 'ScrollAmount_SmallDecrement',
    'UIA_TransformPattern2Id', 'UIA_MarginLeadingAttributeId',
    'UIA_IsTransformPattern2AvailablePropertyId',
    'UIA_RangeValueMaximumPropertyId', 'UIA_FontNameAttributeId',
    'UIA_IsEnabledPropertyId', 'AnnotationType_Comment',
    'IUIAutomationElement5', 'ZoomUnit_LargeDecrement',
    'UIA_HyperlinkControlTypeId',
    'IUIAutomationExpandCollapsePattern',
    'UIA_SayAsInterpretAsAttributeId',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'UIA_InputDiscardedEventId', 'ProviderOptions_OverrideProvider',
    'AnnotationType_EditingLockedChange',
    'IUIAutomationSpreadsheetItemPattern',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'AnnotationType_DataValidationError',
    'NotificationKind_ActionCompleted', 'ExtendedProperty',
    'UIA_DragDropEffectPropertyId', 'AutomationElementMode_Full',
    'IUIAutomationScrollItemPattern', 'ScrollAmount_LargeIncrement',
    'UIA_IsTextPatternAvailablePropertyId',
    'UIA_StylesShapePropertyId', 'HeadingLevel4',
    'UIA_OverlineColorAttributeId', 'UIA_ItemContainerPatternId',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'UIA_LegacyIAccessibleDescriptionPropertyId', 'NavigateDirection',
    'ToggleState_On', 'UIA_FrameworkIdPropertyId',
    'UIA_IsTransformPatternAvailablePropertyId',
    'UIA_CenterPointPropertyId', 'IUIAutomationTextEditPattern',
    'ScrollAmount', 'UIA_IndentationLeadingAttributeId',
    'UIA_TextPattern2Id', 'ExpandCollapseState_Collapsed',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_SpreadsheetItemPatternId', 'UIA_StyleNameAttributeId',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_DragDropEffectsPropertyId', 'TreeTraversalOptions',
    'ZoomUnit_NoAmount', 'UIA_TransformCanMovePropertyId',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'UIA_CustomControlTypeId', 'AnnotationType_Unknown',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'UIA_MenuControlTypeId', 'ProviderOptions_ServerSideProvider',
    'UIA_AnnotationTypesPropertyId', 'IUIAutomationElement2',
    'TextUnit_Character', 'NavigateDirection_PreviousSibling',
    'UIA_SearchLandmarkTypeId', 'HeadingLevel_None',
    'UIA_DropTargetDropTargetEffectPropertyId',
    'StyleId_NumberedList',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'UIA_VisualEffectsPropertyId',
    'UIA_ProviderDescriptionPropertyId', 'UIA_ListItemControlTypeId',
    ...
    'RowOrColumnMajor_Indeterminate', 'UIA_DescribedByPropertyId',
    'AnnotationType_FormulaError',
    'IUIAutomationSynchronizedInputPattern',
    'ScrollAmount_SmallIncrement', 'UIA_SelectionItemPatternId',
    'UIA_IsControlElementPropertyId',
    'TextPatternRangeEndpoint_Start',
    'StructureChangeType_ChildrenBulkRemoved',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'UIA_ValuePatternId', 'UIA_IsSuperscriptAttributeId',
    'StyleId_Heading8', 'IUIAutomationInvokePattern',
    'UIA_LocalizedControlTypePropertyId',
    'IUIAutomationPropertyCondition', 'TextUnit_Format',
    'TreeTraversalOptions_LastToFirstOrder', 'StyleId_Heading6',
    'UIA_Drag_DragCancelEventId', 'NavigateDirection_NextSibling',
    'UIA_DragIsGrabbedPropertyId', 'UIA_DropTarget_DragEnterEventId',
    'UIA_ValueIsReadOnlyPropertyId', 'AnnotationType_Footnote',
    'UIA_TransformPatternId', 'UIA_MenuModeStartEventId',
    'UIA_NotificationEventId',
    'UIA_IsTextPattern2AvailablePropertyId',
    'UIA_Selection2CurrentSelectedItemPropertyId', 'TextUnit_Line',
    'StyleId_Heading3', 'ZoomUnit_SmallIncrement',
    'IUIAutomationElement4', 'AnnotationType_Endnote',
    'HeadingLevel8', 'UIA_RangeValueSmallChangePropertyId',
    'NotificationProcessing_CurrentThenMostRecent',
    'UIA_WindowWindowInteractionStatePropertyId', 'StyleId_Heading9',
    'UIA_Selection2ItemCountPropertyId',
    'UIA_TransformCanRotatePropertyId',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'SynchronizedInputType_KeyUp', 'HeadingLevel5', 'TextUnit_Page',
    'IUIAutomationEventHandler',
    'TextEditChangeType_CompositionFinalized',
    'UIA_MultipleViewCurrentViewPropertyId', 'StyleId_Heading1',
    'StyleId_Heading5', 'UIA_TableItemColumnHeaderItemsPropertyId',
    'UIA_LegacyIAccessibleStatePropertyId',
    'UIA_Invoke_InvokedEventId', 'UIA_DockDockPositionPropertyId',
    ...
    'AnnotationType_InsertionChange', 'UIA_ScrollBarControlTypeId',
    'TextEditChangeType_None', 'HeadingLevel9', 'WindowVisualState',
    'UIA_LegacyIAccessibleRolePropertyId',
    'UIA_AnnotationObjectsAttributeId',
    'UIA_TransformCanResizePropertyId',
    'NotificationProcessing_MostRecent',
    'AnnotationType_UnsyncedChange', 'UIA_ThumbControlTypeId',
    ...
    'StructureChangeType_ChildRemoved', 'AnnotationType_FormatChange',
    'IUIAutomationVirtualizedItemPattern',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_StatusBarControlTypeId',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_HeaderItemControlTypeId', 'IUIAutomationCacheRequest',
    'StyleId_Heading2', 'UIA_WindowIsTopmostPropertyId',
    'TextEditChangeType_Composition', 'StyleId_Quote',
    'UIA_MenuBarControlTypeId', 'UIA_StylesStyleNamePropertyId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'IUIAutomationElement3', 'UIA_TitleBarControlTypeId',
    'IUIAutomationTogglePattern', 'UIA_LinkAttributeId',
    'UIA_GridItemColumnSpanPropertyId', 'UIA_HelpTextPropertyId',
    'UIA_IsDockPatternAvailablePropertyId', 'UIA_ListControlTypeId',
    'UIA_IsGridItemPatternAvailablePropertyId', 'DockPosition_Bottom',
    'UIA_ButtonControlTypeId', 'IUIAutomationCondition',
    'UIA_SizePropertyId', 'UIA_TextControlTypeId',
    'TreeTraversalOptions_Default', 'UIA_StylesFillColorPropertyId',
    'IUIAutomationScrollPattern', 'UIA_SelectionPatternId',
    'UIA_WindowControlTypeId', 'UIA_LandmarkTypePropertyId',
    'UIA_IndentationTrailingAttributeId', 'IUIAutomation',
    'IUIAutomationTransformPattern',
    'WindowInteractionState_NotResponding', 'UIA_FontSizeAttributeId',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'UIA_GridRowCountPropertyId', 'IUIAutomationRangeValuePattern',
    'UIA_DataGridControlTypeId', 'IUIAutomationAnnotationPattern',
    'TreeScope_Element'
]

_check_version('1.1.14', 1655261751.027244)
